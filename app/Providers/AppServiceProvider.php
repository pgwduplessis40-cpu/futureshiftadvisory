...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(PostAcquisitionGapReportComposition::class, PostAcquisitionGapReportComposer::class);
        $this->app->singleton(StandardAdvisoryReportComposition::class, StandardAdvisoryReportComposer::class);
        ...
        $this->app->singleton(DueDiligenceReportComposition::class, DueDiligenceReportComposer::class);
    ...
    protected function configureDefaults(): void
    {
        ...
        Password::defaults(fn (): Password => tap(
            Password::min(12)
                ...
                ->numbers()
                ->symbols(),
            fn (Password $password): mixed => app()->isProduction()
