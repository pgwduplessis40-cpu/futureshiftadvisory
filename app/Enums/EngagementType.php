...
enum EngagementType: string
{
    ...
    case FOUNDING_ADVISORY = 'founding_advisory';
    case NPO = 'npo';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::FOUNDING_ADVISORY => 'Founding Advisory',
            self::NPO => 'NPO',
        };
    }
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::FOUNDING_ADVISORY => 'Launch-focused advisory built from a finalised business plan and a rolling roadmap.',
