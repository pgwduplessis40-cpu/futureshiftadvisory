...
final class StrategicBudgetController extends Controller
{
    ...
    private function validatedBudget(Request $request): array
    {
        return $request->validate([
            ...
            'business_plan_sections.*.financial_drivers' => ['array', 'max:20'],
            'business_plan_sections.*.financial_drivers.*.key' => ['nullable', 'string', 'max:80'],
            'business_plan_sections.*.financial_drivers.*.category' => ['nullable', 'string', Rule::in(['implementation_costs', 'monthly_fixed_costs', 'revenue_forecast', 'funding_sources', 'opening_cash', 'runway_target'])],
            'business_plan_sections.*.financial_drivers.*.label' => ['nullable', 'string', 'max:180'],
            'business_plan_sections.*.financial_drivers.*.amount' => ['nullable', 'numeric', 'min:0', 'max:999999999'],
            'business_plan_sections.*.financial_drivers.*.quantity' => ['nullable', 'numeric', 'min:0', 'max:999999'],
            'business_plan_sections.*.financial_drivers.*.month' => ['nullable', 'integer', 'min:1', 'max:36'],
            'business_plan_sections.*.financial_drivers.*.cadence' => ['nullable', 'string', Rule::in(['weekly', 'fortnightly', 'monthly', 'quarterly', 'annual'])],
            'business_plan_sections.*.financial_drivers.*.cadence_confirmed' => ['nullable', 'boolean'],
            'business_plan_sections.*.financial_drivers.*.growth_percent' => ['nullable', 'numeric', 'min:0', 'max:500'],
            'business_plan_sections.*.financial_drivers.*.growth_cadence' => ['nullable', 'string', Rule::in(['monthly', 'annual'])],
            'business_plan_sections.*.financial_drivers.*.growth_cadence_confirmed' => ['nullable', 'boolean'],
            'business_plan_sections.*.financial_drivers.*.monthly_capacity_units' => ['nullable', 'numeric', 'min:0', 'max:999999'],
            'business_plan_sections.*.financial_drivers.*.capacity_confirmed' => ['nullable', 'boolean'],
            ...
            'implementation_costs.*.plan_financial_driver_key' => ['nullable', 'string', 'max:80'],
            ...
            'monthly_fixed_costs.*.plan_financial_driver_key' => ['nullable', 'string', 'max:80'],
            ...
            'revenue_forecast.*.plan_financial_driver_key' => ['nullable', 'string', 'max:80'],
            ...
            'revenue_forecast.*.growth_percent' => ['nullable', 'numeric', 'min:0', 'max:500'],
            ...
            'funding_sources.*.plan_financial_driver_key' => ['nullable', 'string', 'max:80'],
