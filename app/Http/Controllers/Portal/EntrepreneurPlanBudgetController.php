...
final class EntrepreneurPlanBudgetController extends Controller
{
    ...
    public function budget(Request $request): RedirectResponse|JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'assumptions.opening_cash_verified' => ['nullable', 'boolean'],
            'assumptions.forecast_start_month' => ['nullable', 'date_format:Y-m'],
            'assumptions.forecast_start_confirmed' => ['nullable', 'boolean'],
            'assumptions.debtor_days' => ['nullable', 'integer', 'min:0', 'max:365'],
            'assumptions.creditor_days' => ['nullable', 'integer', 'min:0', 'max:365'],
            'assumptions.working_capital_verified' => ['nullable', 'boolean'],
            'assumptions.funding_position' => ['nullable', 'string', Rule::in(['self_funded', 'external_funding', 'undecided'])],
            'assumptions.funding_position_confirmed' => ['nullable', 'boolean'],
            'assumptions.funding_request_purpose' => ['nullable', 'string', 'max:180'],
            ...
            'monthly_fixed_costs.*.source_type' => ['nullable', 'string', Rule::in(['bank_statement', 'xero_ledger', 'supplier_quote', 'signed_contract', 'pipeline_evidence', 'owner_record', 'unverified'])],
            'monthly_fixed_costs.*.source_reference' => ['nullable', 'string', 'max:180'],
            'monthly_fixed_costs.*.source_confirmed' => ['nullable', 'boolean'],
            ...
            'revenue_forecast.*.founder_capacity_units' => ['nullable', 'numeric', 'min:0', 'max:999999'],
            'revenue_forecast.*.contractor_unit_cost' => ['nullable', 'numeric', 'min:0', 'max:999999999'],
            'revenue_forecast.*.contractor_cost_confirmed' => ['nullable', 'boolean'],
            ...
            'revenue_forecast.*.source_type' => ['nullable', 'string', Rule::in(['bank_statement', 'xero_ledger', 'supplier_quote', 'signed_contract', 'pipeline_evidence', 'owner_record', 'unverified'])],
            'revenue_forecast.*.source_reference' => ['nullable', 'string', 'max:180'],
            'revenue_forecast.*.source_confirmed' => ['nullable', 'boolean'],
            ...
            'funding_scenarios.*.term_years' => ['nullable', 'integer', 'min:1', 'max:30'],
            'funding_scenarios.*.interest_only_months' => ['nullable', 'integer', 'min:0', 'max:359'],
