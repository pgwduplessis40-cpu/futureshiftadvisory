...
final class ProjectSettings
{
    ...
    private const DEFINITIONS = [
        ...
        [
            'key' => 'mail.mailers.graph.auth_mode',
            'group' => 'email_delivery',
            'label' => 'Graph auth mode',
            'type' => self::TYPE_SELECT,
            'config_path' => 'mail.mailers.graph.auth_mode',
            'default' => 'client_credentials',
            'options' => ['client_credentials', 'delegated'],
        ],
        [
        ...
        [
            'key' => 'mail.mailers.graph.authorize_url',
            'group' => 'email_delivery',
            'label' => 'Graph authorize URL',
            'type' => self::TYPE_STRING,
            'config_path' => 'mail.mailers.graph.authorize_url',
            'default' => 'https://login.microsoftonline.com/{tenant}/oauth2/v2.0/authorize',
        ],
        [
            'key' => 'mail.mailers.graph.token_url',
            'group' => 'email_delivery',
            'label' => 'Graph token URL',
            'type' => self::TYPE_STRING,
            'config_path' => 'mail.mailers.graph.token_url',
        ...
        [
            'key' => 'mail.mailers.graph.delegated_scopes',
            'group' => 'email_delivery',
