...
final class PlanAiContext
{
    ...
    private const CRITERION_REQUIREMENT_KEYS = [
        ...
        'discuss the industry' => ['industry-context', 'differentiation', 'competitor-comparison'],
        'what sets the business apart' => ['differentiation', 'competitor-comparison'],
