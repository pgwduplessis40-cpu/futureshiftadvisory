...
final class FallbackGoogleCalendarClient implements GoogleCalendarClient
{
    public function __construct(
        private readonly LiveGoogleCalendarClient $live,
        private readonly FakeGoogleCalendarClient $fake,
    ) {}
