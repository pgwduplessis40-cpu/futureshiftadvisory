...
final class ScreenShareSessionUpdated implements ShouldBroadcastNow
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        private readonly ScreenShareSession $session,
    ) {}
    ...
    {
        return 'screen-share.session-updated';
    }
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'display_surface' => $this->session->display_surface,
        ];
    }
}
