...
paymentComplete.url = (
    ...
    return (
        paymentComplete.definition.url
            .replace(
                '{serviceActivation}',
                parsedArgs.serviceActivation.toString(),
            )
...
const serviceActivations = {
    ...
    paymentComplete: Object.assign(paymentComplete, paymentComplete),
