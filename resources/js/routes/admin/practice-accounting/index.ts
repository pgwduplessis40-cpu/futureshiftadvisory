...
export const revoke = (
    args:
        | { practiceAccountingConnection: string | { id: string } }
        | [practiceAccountingConnection: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
revoke.url = (
    ...
    const parsedArgs = {
        practiceAccountingConnection:
            typeof args.practiceAccountingConnection === 'object'
    ...
    return (
        revoke.definition.url
            .replace(
                '{practiceAccountingConnection}',
                parsedArgs.practiceAccountingConnection.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
export default practiceAccounting;
