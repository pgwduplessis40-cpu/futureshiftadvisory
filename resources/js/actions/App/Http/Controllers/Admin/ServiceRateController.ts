...
export const toggle = (
    args:
        | { serviceRateSetting: string | { id: string } }
        | [serviceRateSetting: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
toggle.url = (
    ...
    const parsedArgs = {
        serviceRateSetting:
            typeof args.serviceRateSetting === 'object'
    ...
    return (
        toggle.definition.url
            .replace(
                '{serviceRateSetting}',
                parsedArgs.serviceRateSetting.toString(),
            )
...
export const updatePackage = (
    args:
        | { serviceRatePackage: string | { id: string } }
        | [serviceRatePackage: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
updatePackage.url = (
    ...
    const parsedArgs = {
        serviceRatePackage:
            typeof args.serviceRatePackage === 'object'
                ? args.serviceRatePackage.id
                : args.serviceRatePackage,
    };

    return (
        updatePackage.definition.url
            .replace(
                '{serviceRatePackage}',
                parsedArgs.serviceRatePackage.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const storeIntegrationFeeBand = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/service-rates/integration-fee-bands'
 */
const storeIntegrationFeeBandForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/service-rates/integration-fee-bands'
 */
storeIntegrationFeeBandForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: storeIntegrationFeeBand.url(options),
    method: 'post',
 ...
 */
export const importIntegrationFeeBands = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/service-rates/integration-fee-bands/import'
 */
importIntegrationFeeBands.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: importIntegrationFeeBands.url(options),
    method: 'post',
 ...
 * @route '/admin/service-rates/integration-fee-bands/import'
 */
const importIntegrationFeeBandsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/service-rates/integration-fee-bands/import'
 */
importIntegrationFeeBandsForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: importIntegrationFeeBands.url(options),
    method: 'post',
...
const ServiceRateController = {
    ...
    updatePackage,
    togglePackage,
    storeIntegrationFeeBand,
    importIntegrationFeeBands,
};
