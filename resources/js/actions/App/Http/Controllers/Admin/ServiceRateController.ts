 ...
 * @see app/Http/Controllers/Admin/ServiceRateController.php:20
 ...
 * @see app/Http/Controllers/Admin/ServiceRateController.php:41
 * @route '/admin/service-rates'
 */
...
const ServiceRateController = { index, store }
