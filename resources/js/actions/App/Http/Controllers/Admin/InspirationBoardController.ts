 ...
 */
export const cancelRotation = (
    args:
        | { rotationSchedule: string | { id: string } }
        | [rotationSchedule: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
cancelRotation.url = (
    ...
    const parsedArgs = {
        rotationSchedule:
            typeof args.rotationSchedule === 'object'
                ? args.rotationSchedule.id
                : args.rotationSchedule,
    };

    return (
        cancelRotation.definition.url
            .replace(
                '{rotationSchedule}',
                parsedArgs.rotationSchedule.toString(),
            )
...
const InspirationBoardController = {
    index,
    store,
    scheduleRotation,
    cancelRotation,
