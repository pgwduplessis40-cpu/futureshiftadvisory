 ...
 * @see app/Http/Controllers/Admin/ReferenceDataController.php:51
 * @route '/admin/reference-data'
 */
export const store = (
    options?: RouteQueryOptions,
 ...
 * @see app/Http/Controllers/Admin/ReferenceDataController.php:108
 * @route '/admin/reference-data/evidence/{document}'
 */
export const evidence = (
    args:
        | { document: string | { id: string } }
        | [document: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
const ReferenceDataController = { index, store, evidence };
