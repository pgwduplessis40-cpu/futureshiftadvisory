 ...
 * @see app/Http/Controllers/Admin/ReferenceDataController.php:34
 ...
 * @see app/Http/Controllers/Admin/ReferenceDataController.php:56
 * @route '/admin/reference-data'
 */
...
const ReferenceDataController = { index, store }
