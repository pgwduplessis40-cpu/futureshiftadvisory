...
* @see app/Http/Controllers/Admin/ReferenceDataController.php:41
...
*/
export const refreshEconomicIndicators = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: refreshEconomicIndicators.url(options),
    method: 'post',
})

refreshEconomicIndicators.definition = {
    methods: ["post"],
...
* @route '/admin/reference-data/economic-indicators/refresh'
*/
refreshEconomicIndicators.url = (options?: RouteQueryOptions) => {
    return refreshEconomicIndicators.definition.url + queryParams(options)
}
...
* @route '/admin/reference-data/economic-indicators/refresh'
*/
refreshEconomicIndicators.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: refreshEconomicIndicators.url(options),
    method: 'post',
})
...
* @route '/admin/reference-data/economic-indicators/refresh'
*/
const refreshEconomicIndicatorsForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: refreshEconomicIndicators.url(options),
    method: 'post',
})
...
* @route '/admin/reference-data/economic-indicators/refresh'
*/
refreshEconomicIndicatorsForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: refreshEconomicIndicators.url(options),
    method: 'post',
})
