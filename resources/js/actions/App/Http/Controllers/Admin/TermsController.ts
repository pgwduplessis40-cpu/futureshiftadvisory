...
edit.url = (
    ...
    const parsedArgs = {
        termsVersion:
            typeof args.termsVersion === 'object'
...
uploadSourceFile.url = (
    ...
    return (
        uploadSourceFile.definition.url
            .replace('{termsVersion}', parsedArgs.termsVersion.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const downloadSourceFile = (
    args:
        | { termsVersion: string | { id: string } }
        | [termsVersion: string | { id: string }]
        | string
...
downloadSourceFile.url = (
    ...
    return (
        downloadSourceFile.definition.url
            .replace('{termsVersion}', parsedArgs.termsVersion.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const activateEnforcement = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
