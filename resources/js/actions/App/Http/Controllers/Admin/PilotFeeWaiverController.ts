...
updateEntrepreneur.url = (
    ...
    return (
        updateEntrepreneur.definition.url
            .replace(
                '{entrepreneurProfile}',
...
const PilotFeeWaiverController = {
    index,
    updateProgram,
    updateClient,
    updateEntrepreneur,
