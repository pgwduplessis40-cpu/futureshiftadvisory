...
export const decide = (
    args:
        | { learningUpdate: string | { id: string } }
        | [learningUpdate: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
decide.url = (
    ...
    const parsedArgs = {
        learningUpdate:
            typeof args.learningUpdate === 'object'
                ? args.learningUpdate.id
                : args.learningUpdate,
    };

    return (
        decide.definition.url
...
export const reviewImpact = (
    args:
        | { learningUpdateImplementation: string | { id: string } }
        | [learningUpdateImplementation: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
reviewImpact.url = (
    ...
    const parsedArgs = {
        learningUpdateImplementation:
            typeof args.learningUpdateImplementation === 'object'
                ? args.learningUpdateImplementation.id
                : args.learningUpdateImplementation,
    };

    return (
        reviewImpact.definition.url
            .replace(
                '{learningUpdateImplementation}',
                parsedArgs.learningUpdateImplementation.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
const LearningUpdateController = {
    index,
    rerun,
    decide,
    reviewImpact,
