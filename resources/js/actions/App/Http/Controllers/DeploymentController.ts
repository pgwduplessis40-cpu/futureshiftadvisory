...
*/
const DeploymentController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/deployment'
*/
DeploymentController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: DeploymentController.url(options),
    method: 'get',
})
...
* @route '/api/deployment'
*/
DeploymentController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: DeploymentController.url(options),
    method: 'head',
})
...
* @route '/api/deployment'
*/
const DeploymentControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/deployment'
*/
DeploymentControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: DeploymentController.url(options),
    method: 'get',
})
...
* @route '/api/deployment'
*/
DeploymentControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
