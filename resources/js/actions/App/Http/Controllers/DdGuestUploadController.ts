...
DdGuestUploadController.url = (
    ...
    return (
        DdGuestUploadController.definition.url
 ...
 * @route '/api/dd/guest-uploads/{token}'
 */
const DdGuestUploadControllerForm = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 * @route '/api/dd/guest-uploads/{token}'
 */
DdGuestUploadControllerForm.post = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
