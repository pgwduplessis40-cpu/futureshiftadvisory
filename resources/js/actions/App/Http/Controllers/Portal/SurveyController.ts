 ...
 * @see app/Http/Controllers/Portal/SurveyController.php:25
 ...
 * @route '/portal/surveys/{surveyAssignment}/draft'
 */
...
draft.definition = {
    methods: ["post"],
    url: '/portal/surveys/{surveyAssignment}/draft',
...
const SurveyController = { index, show, draft, submit }
