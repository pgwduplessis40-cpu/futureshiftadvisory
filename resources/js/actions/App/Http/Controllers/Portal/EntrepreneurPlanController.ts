 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:94
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:138
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:206
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:224
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:246
 * @route '/portal/entrepreneur/idea-validation/recall'
 */
export const recallIdeaValidation = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur/idea-validation/recall'
 */
const recallIdeaValidationForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:262
 * @route '/portal/entrepreneur/idea-validation/{ideaValidation}/restore'
 */
export const restoreIdeaValidation = (
    args:
        | { ideaValidation: string | { id: string } }
        | [ideaValidation: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
restoreIdeaValidation.url = (
    ...
    const parsedArgs = {
        ideaValidation:
            typeof args.ideaValidation === 'object'
                ? args.ideaValidation.id
                : args.ideaValidation,
    };

    return (
        restoreIdeaValidation.definition.url
 ...
 * @route '/portal/entrepreneur/idea-validation/{ideaValidation}/restore'
 */
const restoreIdeaValidationForm = (
    args:
        | { ideaValidation: string | { id: string } }
        | [ideaValidation: string | { id: string }]
        | string
 ...
 * @route '/portal/entrepreneur/idea-validation/{ideaValidation}/restore'
 */
restoreIdeaValidationForm.post = (
    args:
        | { ideaValidation: string | { id: string } }
        | [ideaValidation: string | { id: string }]
        | string
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:282
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:501
 * @route '/portal/entrepreneur/plan/requirements/assist'
 */
export const assistRequirement = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:383
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:165
 * @route '/portal/entrepreneur/plan/budget-pack'
 */
export const budgetPack = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:460
 * @route '/portal/entrepreneur/plan/budget/flags/acknowledge'
 */
export const acknowledgeBudgetFlag = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur/plan/budget/flags/acknowledge'
 */
const acknowledgeBudgetFlagForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur/plan/budget/flags/acknowledge'
 */
acknowledgeBudgetFlagForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: acknowledgeBudgetFlag.url(options),
    method: 'post',
 ...
 */
export const dismissBudgetAdvisorNudge = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur/plan/budget/advisor-nudge/dismiss'
 */
dismissBudgetAdvisorNudge.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: dismissBudgetAdvisorNudge.url(options),
    method: 'post',
 ...
 * @route '/portal/entrepreneur/plan/budget/advisor-nudge/dismiss'
 */
const dismissBudgetAdvisorNudgeForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur/plan/budget/advisor-nudge/dismiss'
 */
dismissBudgetAdvisorNudgeForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: dismissBudgetAdvisorNudge.url(options),
    method: 'post',
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:543
 ...
 * @see app/Http/Controllers/Portal/EntrepreneurPlanController.php:577
 * @route '/portal/entrepreneur/advisory-request'
 */
export const requestAdvisory = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
...
const EntrepreneurPlanController = {
    show,
    preview,
    readiness,
    ideaValidation,
    recallIdeaValidation,
    restoreIdeaValidation,
    start,
    assistRequirement,
    section,
    guidance,
