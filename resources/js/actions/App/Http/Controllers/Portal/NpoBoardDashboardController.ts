 ...
 */
const NpoBoardDashboardController = (
 ...
 * @route '/portal/npo-board'
 */
NpoBoardDashboardController.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: NpoBoardDashboardController.url(options),
    method: 'get',
 ...
 * @route '/portal/npo-board'
 */
NpoBoardDashboardController.head = (
    options?: RouteQueryOptions,
 ...
 * @route '/portal/npo-board'
 */
const NpoBoardDashboardControllerForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/portal/npo-board'
 */
NpoBoardDashboardControllerForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: NpoBoardDashboardController.url(options),
    method: 'get',
 ...
 * @route '/portal/npo-board'
 */
NpoBoardDashboardControllerForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
