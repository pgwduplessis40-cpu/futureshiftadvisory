...
registerAdvisor.url = (
    ...
    return (
        registerAdvisor.definition.url
 ...
 */
export const registerAdvisorForEntrepreneur = (
    args:
 ...
 * @route '/advisor/entrepreneurs/{entrepreneurProfile}/co-browse/connections'
 */
registerAdvisorForEntrepreneur.url = (
    args:
        | { entrepreneurProfile: string | { id: string } }
        | [entrepreneurProfile: string | { id: string }]
        | string
    ...
    return (
        registerAdvisorForEntrepreneur.definition.url
            .replace(
                '{entrepreneurProfile}',
 ...
 * @route '/advisor/entrepreneurs/{entrepreneurProfile}/co-browse/connections'
 */
registerAdvisorForEntrepreneur.post = (
    args:
        | { entrepreneurProfile: string | { id: string } }
        | [entrepreneurProfile: string | { id: string }]
        | string
 ...
 * @route '/advisor/entrepreneurs/{entrepreneurProfile}/co-browse/connections'
 */
const registerAdvisorForEntrepreneurForm = (
    args:
        | { entrepreneurProfile: string | { id: string } }
        | [entrepreneurProfile: string | { id: string }]
        | string
 ...
 * @route '/advisor/entrepreneurs/{entrepreneurProfile}/co-browse/connections'
 */
registerAdvisorForEntrepreneurForm.post = (
    args:
        | { entrepreneurProfile: string | { id: string } }
        | [entrepreneurProfile: string | { id: string }]
        | string
...
const CoBrowseConnectionController = {
    registerAdvisor,
    registerAdvisorForEntrepreneur,
    registerClient,
    pendingPrompt,
    heartbeat,
};
