 ...
 */
export const confirmWebsiteUrl = (args: { client: string | { id: string } } | [client: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: confirmWebsiteUrl.url(args, options),
    method: 'post',
})

confirmWebsiteUrl.definition = {
    methods: ["post"],
    url: '/advisor/clients/{client}/standard-advisory/website-url',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/advisor/clients/{client}/standard-advisory/website-url'
 */
confirmWebsiteUrl.url = (args: { client: string | { id: string } } | [client: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { client: args }
    }
    ...
    return confirmWebsiteUrl.definition.url
            .replace('{client}', parsedArgs.client.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/advisor/clients/{client}/standard-advisory/website-url'
 */
confirmWebsiteUrl.post = (args: { client: string | { id: string } } | [client: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: confirmWebsiteUrl.url(args, options),
    method: 'post',
})
 ...
 * @route '/advisor/clients/{client}/standard-advisory/website-url'
 */
    const confirmWebsiteUrlForm = (args: { client: string | { id: string } } | [client: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: confirmWebsiteUrl.url(args, options),
        method: 'post',
    })
 ...
 * @route '/advisor/clients/{client}/standard-advisory/website-url'
 */
        confirmWebsiteUrlForm.post = (args: { client: string | { id: string } } | [client: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: confirmWebsiteUrl.url(args, options),
            method: 'post',
        })
