 ...
 */
export const requestIdeaChanges = (
    args:
        | {
              entrepreneurProfile: string | { id: string };
              ideaValidation: string | { id: string };
...
requestIdeaChanges.url = (
    ...
    return (
        requestIdeaChanges.definition.url
            .replace(
                '{entrepreneurProfile}',
                parsedArgs.entrepreneurProfile.toString(),
            )
    ...
    const parsedArgs = {
        entrepreneurProfile:
            typeof args.entrepreneurProfile === 'object'
                ...
                : args.entrepreneurProfile,
        businessPlan:
            typeof args.businessPlan === 'object'
                ? args.businessPlan.id
                : args.businessPlan,
    };

    return (
        assess.definition.url
            .replace(
                '{entrepreneurProfile}',
                parsedArgs.entrepreneurProfile.toString(),
            )
...
export const finalise = (
    args:
        | {
              entrepreneurProfile: string | { id: string };
              planAssessment: string | { id: string };
          }
        | [
              entrepreneurProfile: string | { id: string },
              planAssessment: string | { id: string },
    ...
    const parsedArgs = {
        entrepreneurProfile:
            typeof args.entrepreneurProfile === 'object'
                ...
                : args.entrepreneurProfile,
        planAssessment:
            typeof args.planAssessment === 'object'
                ? args.planAssessment.id
                : args.planAssessment,
    };

    return (
        finalise.definition.url
            .replace(
                '{entrepreneurProfile}',
                parsedArgs.entrepreneurProfile.toString(),
            )
...
setGamification.url = (
    ...
    return (
        setGamification.definition.url
            .replace(
                '{entrepreneurProfile}',
                parsedArgs.entrepreneurProfile.toString(),
            )
...
const EntrepreneurActionController = {
    gateIdea,
    requestIdeaChanges,
    refreshIdea,
    assess,
