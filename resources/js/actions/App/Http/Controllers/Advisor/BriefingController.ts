 ...
 */
export const reviewIndustry = (
    args:
        | { industryBriefing: string | { id: string } }
        | [industryBriefing: string | { id: string }]
        | string
        | { id: string },
...
reviewIndustry.url = (
    ...
    const parsedArgs = {
        industryBriefing:
            typeof args.industryBriefing === 'object'
                ? args.industryBriefing.id
                : args.industryBriefing,
    };

    return (
        reviewIndustry.definition.url
            .replace(
                '{industryBriefing}',
                parsedArgs.industryBriefing.toString(),
            )
 ...
 */
export const reviewPreMeeting = (
    args:
        | { preMeetingBrief: string | { id: string } }
        | [preMeetingBrief: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
reviewPreMeeting.url = (
    ...
    const parsedArgs = {
        preMeetingBrief:
            typeof args.preMeetingBrief === 'object'
                ? args.preMeetingBrief.id
                : args.preMeetingBrief,
    };

    return (
        reviewPreMeeting.definition.url
