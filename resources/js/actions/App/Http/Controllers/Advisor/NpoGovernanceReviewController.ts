...
export const run = (
    args:
        | { npoEngagement: string | { id: string } }
        | [npoEngagement: string | { id: string }]
        | string
        | { id: string },
...
run.url = (
    ...
    const parsedArgs = {
        npoEngagement:
            typeof args.npoEngagement === 'object'
...
export const review = (
    args:
        | { governanceReviewFinding: string | { id: string } }
        | [governanceReviewFinding: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
review.url = (
    ...
    const parsedArgs = {
        governanceReviewFinding:
            typeof args.governanceReviewFinding === 'object'
    ...
    return (
        review.definition.url
            .replace(
                '{governanceReviewFinding}',
                parsedArgs.governanceReviewFinding.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
