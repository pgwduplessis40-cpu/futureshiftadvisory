...
export const show = (
    args:
        | {
              entrepreneurProfile: string | { id: string };
              messageThread: string | { id: string };
          }
        | [
              entrepreneurProfile: string | { id: string },
              messageThread: string | { id: string },
    ...
    const parsedArgs = {
        entrepreneurProfile:
            typeof args.entrepreneurProfile === 'object'
                ...
                : args.entrepreneurProfile,
        messageThread:
            typeof args.messageThread === 'object'
 ...
 */
export const disableGamification = (
    args:
        | {
              entrepreneurProfile: string | { id: string };
              messageThread: string | { id: string };
...
disableGamification.url = (
    ...
    return (
        disableGamification.definition.url
            .replace(
                '{entrepreneurProfile}',
                parsedArgs.entrepreneurProfile.toString(),
            )
...
const EntrepreneurMessageController = {
    index,
    store,
    show,
    reply,
