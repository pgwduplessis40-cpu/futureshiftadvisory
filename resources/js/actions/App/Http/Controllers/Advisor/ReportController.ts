...
export const updateSection = (
    args:
        | {
              report: string | { id: string };
              reportSection: string | { id: string };
          }
        | [
              report: string | { id: string },
              reportSection: string | { id: string },
...
updateSection.url = (
    ...
    const parsedArgs = {
        report: typeof args.report === 'object' ? args.report.id : args.report,
        reportSection:
            typeof args.reportSection === 'object'
                ? args.reportSection.id
                : args.reportSection,
    };

    return (
        updateSection.definition.url
            .replace('{report}', parsedArgs.report.toString())
