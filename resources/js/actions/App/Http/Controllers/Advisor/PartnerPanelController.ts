 ...
 * @see app/Http/Controllers/Advisor/PartnerPanelController.php:36
 ...
 */
    ...
    show.form = showForm
const PartnerPanelController = { brokers, createBroker, storeBroker, coaches, createCoach, storeCoach, show }
