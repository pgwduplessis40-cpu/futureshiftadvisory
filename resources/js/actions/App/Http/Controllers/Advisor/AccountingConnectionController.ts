...
export const connect = (
    args:
        | { client: string | { id: string }; provider: string | number }
        | [client: string | { id: string }, provider: string | number],
 ...
 */
export const callbackFromState = (
    args:
...
callbackFromState.url = (
    ...
    return (
        callbackFromState.definition.url
            .replace('{provider}', parsedArgs.provider.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
export const pull = (
    args:
        | {
              ...
              accountingConnection: string | { id: string };
          }
        | [
              client: string | { id: string },
              accountingConnection: string | { id: string },
...
pull.url = (
    ...
    const parsedArgs = {
        ...
        accountingConnection:
            typeof args.accountingConnection === 'object'
    ...
    return (
        pull.definition.url
            ...
            .replace(
                '{accountingConnection}',
                parsedArgs.accountingConnection.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
const AccountingConnectionController = {
    connect,
    callbackFromState,
    callback,
    pull,
