...
export const show = (
    args:
        | { integrationScope: string | { id: string } }
        | [integrationScope: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
show.url = (
    ...
    const parsedArgs = {
        integrationScope:
            typeof args.integrationScope === 'object'
    ...
    return (
        show.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 */
export const createFeeCalculation = (
    args:
        | { integrationScope: string | { id: string } }
        | [integrationScope: string | { id: string }]
        | string
...
createFeeCalculation.url = (
    ...
    return (
        createFeeCalculation.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/fee-calculations'
 */
const createFeeCalculationForm = (
    args:
        | { integrationScope: string | { id: string } }
        | [integrationScope: string | { id: string }]
        | string
 ...
 */
export const extractQuoteSources = (
    args:
        | { integrationScope: string | { id: string } }
        | [integrationScope: string | { id: string }]
        | string
...
extractQuoteSources.url = (
    ...
    return (
        extractQuoteSources.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 */
export const retryQuoteSourceExtraction = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
          }
        | [
              integrationScope: string | { id: string },
              quoteSourceExtraction: string | { id: string },
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/retry'
 */
retryQuoteSourceExtraction.url = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
    ...
    const parsedArgs = {
        integrationScope:
            typeof args.integrationScope === 'object'
                ? args.integrationScope.id
                : args.integrationScope,
        quoteSourceExtraction:
            typeof args.quoteSourceExtraction === 'object'
                ? args.quoteSourceExtraction.id
                : args.quoteSourceExtraction,
    };

    return (
        retryQuoteSourceExtraction.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
            .replace(
                '{quoteSourceExtraction}',
                parsedArgs.quoteSourceExtraction.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/retry'
 */
retryQuoteSourceExtraction.post = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/retry'
 */
const retryQuoteSourceExtractionForm = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/retry'
 */
retryQuoteSourceExtractionForm.post = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 */
export const confirmQuoteSourceRows = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
...
confirmQuoteSourceRows.url = (
    ...
    return (
        confirmQuoteSourceRows.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/confirm'
 */
const confirmQuoteSourceRowsForm = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/confirm'
 */
confirmQuoteSourceRowsForm.post = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 */
export const rejectQuoteSourceRows = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
...
rejectQuoteSourceRows.url = (
    ...
    return (
        rejectQuoteSourceRows.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/reject'
 */
const rejectQuoteSourceRowsForm = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-extractions/{quoteSourceExtraction}/reject'
 */
rejectQuoteSourceRowsForm.post = (
    args:
        | {
              integrationScope: string | { id: string };
              quoteSourceExtraction: string | { id: string };
 ...
 */
export const showQuoteSourceDocument = (
    args:
        | {
              integrationScope: string | { id: string };
...
showQuoteSourceDocument.url = (
    ...
    return (
        showQuoteSourceDocument.definition.url
            .replace(
                '{integrationScope}',
                parsedArgs.integrationScope.toString(),
            )
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-documents/{document}'
 */
const showQuoteSourceDocumentForm = (
    args:
        | {
              integrationScope: string | { id: string };
              document: string | number;
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-documents/{document}'
 */
showQuoteSourceDocumentForm.get = (
    args:
        | {
              integrationScope: string | { id: string };
              document: string | number;
 ...
 * @route '/advisor/integration-scopes/{integrationScope}/quote-source-documents/{document}'
 */
showQuoteSourceDocumentForm.head = (
    args:
        | {
              integrationScope: string | { id: string };
              document: string | number;
...
const IntegrationScopeController = {
    index,
    show,
    store,
    update,
    ...
    extractQuoteSources,
    retryQuoteSourceExtraction,
    confirmQuoteSourceRows,
    rejectQuoteSourceRows,
    showQuoteSourceDocument,
};
