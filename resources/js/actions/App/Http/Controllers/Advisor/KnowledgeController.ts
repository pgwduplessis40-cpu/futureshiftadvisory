...
draftFromClient.url = (
    ...
    return (
        draftFromClient.definition.url
...
export const reviewDraft = (
    args:
        | { knowledgeEntryDraft: string | { id: string } }
        | [knowledgeEntryDraft: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
reviewDraft.url = (
    ...
    const parsedArgs = {
        knowledgeEntryDraft:
            typeof args.knowledgeEntryDraft === 'object'
                ? args.knowledgeEntryDraft.id
                : args.knowledgeEntryDraft,
    };

    return (
        reviewDraft.definition.url
            .replace(
                '{knowledgeEntryDraft}',
                parsedArgs.knowledgeEntryDraft.toString(),
            )
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
export const show = (
    args:
        | { knowledgeEntry: string | { id: string } }
        | [knowledgeEntry: string | { id: string }]
        | string
        | { id: string },
    options?: RouteQueryOptions,
...
show.url = (
    ...
    const parsedArgs = {
        knowledgeEntry:
            typeof args.knowledgeEntry === 'object'
