...
/**
* @see \App\Http\Controllers\Advisor\OffboardingController::create
 * @see app/Http/Controllers/Advisor/OffboardingController.php:20
 * @route '/advisor/clients/{client}/offboarding'
 */
...
create.definition = {
    methods: ["get","head"],
    url: '/advisor/clients/{client}/offboarding',
...
const OffboardingController = { create, store }
