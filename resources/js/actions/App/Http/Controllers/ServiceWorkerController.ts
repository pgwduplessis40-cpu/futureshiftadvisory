...
* @route '/sw.js'
*/
const ServiceWorkerController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/sw.js'
*/
ServiceWorkerController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ServiceWorkerController.url(options),
    method: 'get',
})
...
* @route '/sw.js'
*/
ServiceWorkerController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: ServiceWorkerController.url(options),
    method: 'head',
})
...
* @route '/sw.js'
*/
const ServiceWorkerControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/sw.js'
*/
ServiceWorkerControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ServiceWorkerController.url(options),
    method: 'get',
})
...
* @route '/sw.js'
*/
ServiceWorkerControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
