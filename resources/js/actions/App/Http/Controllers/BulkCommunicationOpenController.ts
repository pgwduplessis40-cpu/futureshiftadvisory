 ...
 */
const BulkCommunicationOpenController = (
    args:
 ...
 * @route '/communications/open/{token}.gif'
 */
BulkCommunicationOpenController.url = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    ...
    return (
        BulkCommunicationOpenController.definition.url
 ...
 * @route '/communications/open/{token}.gif'
 */
BulkCommunicationOpenController.get = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/communications/open/{token}.gif'
 */
BulkCommunicationOpenController.head = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 * @route '/communications/open/{token}.gif'
 */
const BulkCommunicationOpenControllerForm = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 * @route '/communications/open/{token}.gif'
 */
BulkCommunicationOpenControllerForm.get = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/communications/open/{token}.gif'
 */
BulkCommunicationOpenControllerForm.head = (
    args:
        { token: string | number } | [token: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
