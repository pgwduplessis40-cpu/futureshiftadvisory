...
ReferralStageController.url = (
    ...
    return (
        ReferralStageController.definition.url
 ...
 * @route '/broker/referrals/{referral}/stage'
 */
const ReferralStageControllerForm = (
    args:
        | { referral: string | { id: string } }
        | [referral: string | { id: string }]
        | string
 ...
 * @route '/broker/referrals/{referral}/stage'
 */
ReferralStageControllerForm.patch = (
    args:
        | { referral: string | { id: string } }
        | [referral: string | { id: string }]
        | string
