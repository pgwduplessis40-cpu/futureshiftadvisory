 ...
 */
export const registerPortalParticipant = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur-screen-share/connections'
 */
registerPortalParticipant.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: registerPortalParticipant.url(options),
    method: 'post',
 ...
 * @route '/portal/entrepreneur-screen-share/connections'
 */
const registerPortalParticipantForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/portal/entrepreneur-screen-share/connections'
 */
registerPortalParticipantForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: registerPortalParticipant.url(options),
    method: 'post',
...
const EntrepreneurScreenShareController = {
    registerAdvisor,
    store,
