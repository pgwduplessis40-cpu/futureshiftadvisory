...
### AI Integrity Principle (spec Section 3)
...
### Document AI Verification (spec Section 9)
...
### Security baseline (spec Section 4, with Phase 1 deviations)
...
This repo includes a project skill at `.claude/skills/fsa-app/SKILL.md`. Use `/fsa-app` or let Claude load it automatically for FSA implementation, review, analysis, reporting, proposal, strategic-plan, document, AI, or calendar work. Keep this file concise; move workflow-specific or repeatable operating rules into the skill instead of expanding project memory.
...
4. Before any AI-touching change, re-read PLAN.md Section 7.1 and CLAUDE.md "AI Integrity Principle" above.
5. Before any data-access change, re-read PLAN.md Section 7.4 (integration pattern) and Section 6.2 (RLS).

### Repo map (high-level - full map in PLAN.md Section 4)
```
...
- Or update `PLAN.md` Section 12 (Open risks) with a new row and reference it in commit messages.

---

## Phase 1 quick reference

If you ever forget what's in scope vs. out of scope, this is the short version (see PLAN.md Section 2 for the full list):
