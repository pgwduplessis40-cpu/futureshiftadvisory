...
Route::middleware(['auth', 'verified', 'mfa'])
    ...
    ->group(function (): void {
        ...
        Route::patch('entrepreneurs/{entrepreneurProfile}/idea-validations/{ideaValidation}/request-changes', [EntrepreneurActionController::class, 'requestIdeaChanges'])
            ->middleware('permission:'.Permission::ENTREPRENEURS_ASSESS->value)
            ->name('entrepreneurs.idea-validations.request-changes');
        ...
        Route::post('entrepreneurs/{entrepreneurProfile}/assessments/{planAssessment}/feedback/plain-language-draft', [EntrepreneurActionController::class, 'regenerateAssessmentFeedbackDraft'])
            ->middleware('permission:'.Permission::ENTREPRENEURS_ASSESS->value)
            ->name('entrepreneurs.assessments.feedback.plain-language-draft');
