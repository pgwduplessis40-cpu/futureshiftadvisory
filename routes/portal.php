...
use App\Http\Controllers\Portal\EntrepreneurPlanBudgetCheckoutController;
...
Route::middleware(['auth', 'verified', 'mfa', EnsureEntrepreneurInviteOfferAccepted::class])
    ...
    ->group(function (): void {
        ...
        Route::post('entrepreneur/plan/budget', [EntrepreneurPlanBudgetController::class, 'budget'])->name('entrepreneur.plan.budget.update');
        Route::get('entrepreneur/plan/budget-pack', [EntrepreneurPlanDocumentController::class, 'budgetPack'])->name('entrepreneur.plan.budget-pack.show');
        Route::get('entrepreneur/plan/budget-pack/pdf', [EntrepreneurPlanDocumentController::class, 'budgetPackPdf'])->name('entrepreneur.plan.budget-pack.pdf');
        Route::post('entrepreneur/plan/budget/flags/acknowledge', [EntrepreneurPlanBudgetController::class, 'acknowledgeBudgetFlag'])->name('entrepreneur.plan.budget.flags.acknowledge');
        Route::post('entrepreneur/plan/budget/advisor-nudge/dismiss', [EntrepreneurPlanBudgetController::class, 'dismissBudgetAdvisorNudge'])->name('entrepreneur.plan.budget.advisor-nudge.dismiss');
        Route::post('entrepreneur/plan/submit', [EntrepreneurPlanController::class, 'submit'])->name('entrepreneur.plan.submit');
        Route::post('entrepreneur/advisory-request', [EntrepreneurAdvisoryRequestController::class, 'requestAdvisory'])->name('entrepreneur.advisory-request.store');
