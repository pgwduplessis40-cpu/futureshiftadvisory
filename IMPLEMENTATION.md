...
**NPO Module:** **COMPLETE** (19/19 NPO work orders complete on `featureApp`).
...
| | |
|---|---|
| Work orders complete | **158 total** - Phase 1 (30) + Phase 2 (34) + Phase 3 (37, incl. WO-87a/87b) + Phase 4 (19, WO-102...WO-120) + Dashboard Interactivity (9, WO-D01...WO-D09) + Methodology Registry (5, WO-M01...WO-M05) + V2.4 Gap Closure (5, WO-121...WO-125) + NPO Module (19/19 complete) |
...
| Next work order | None - NPO Module complete |
...
| Verification status | **WO-N19 final baseline (2026-05-27):** focused NPO PHPUnit **70 tests / 654 assertions**; WO-N19 fee/integration slice **5 tests / 39 assertions**; fee/governance/methodology regression slice **12 tests / 438 assertions**; `npm run types:check`, `npm run lint:check`, `npm run format:check`, and Pint are green. |
...
| WO-N17 | `33c29cd` Complete | Adds the remaining NPO report templates: client-facing NPO Health, confidential Cognac NPO Advisor with mission-ROI workings, and Social Enterprise Dual Impact with reviewed evidenced tensions; advisor generation, portal visibility, and board report-type gating are covered. |
...
| WO-N19 | This commit | Adds flag-gated NPO funder integrations that emit governed Layer-34 candidates, the NPO retainer fee method with 35% SME discount, pro-bono tracking, social-enterprise rate rationale, accountability-report add-ons, and the CLAUDE.md NPO rules block. |
