...
| `entrepreneur-module.md` | WO-82/83/84 | Entrepreneur readiness assessment, profile-scoped RLS, raw personal-barrier coaching signals, idea validation, viability alerts, advisor gate, and five-phase plan builder |
