...
| `entrepreneur-module.md` | WO-82/83/84/85/86 | Entrepreneur readiness assessment, profile-scoped RLS, raw personal-barrier coaching signals, idea validation, viability alerts, advisor gate, five-phase plan builder, AI guidance, predictive score, NZ resources, and section document verification |
