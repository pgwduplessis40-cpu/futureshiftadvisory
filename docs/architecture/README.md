...
| `entrepreneur-module.md` | WO-82/83 | Entrepreneur readiness assessment, profile-scoped RLS, raw personal-barrier coaching signals, idea validation, viability alerts, and advisor gate |
