...
| `panels.md` | WO-70-73 | Shared broker/coach panel onboarding, broker FSP validation, coach vetting, coach signal suggestions, agreement gate, referrals, and reverse referrals |
